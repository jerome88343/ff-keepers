...
const DATA = {
  ...
  teams: [
    ...
    { id:"cd", name:"Pink Taco Pluggers", owner:"Chris", slot:null, paid:false, insurance:false,
      keepers:[
    ...
    { id:"jn", name:"My Couch Pulls Out, But I Don't.", owner:"Jason", slot:null, paid:false, insurance:true,
      keepers:[
    ...
    { id:"cd_chad", name:"LaFlama Blanca",        owner:"Chad",        slot:1, paid:false, insurance:false, keepers:[] },
